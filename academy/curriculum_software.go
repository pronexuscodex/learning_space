...
accounts.`,
		...
		Resources: []Resource{
			{"Site", "OWASP Top 10", "https://owasp.org/www-project-top-ten/", "The most critical web-application security risks."},
...
crew scheduling and chip layout rely on solvers for NP-hard problems.`,
		...
		Resources: []Resource{
			...
			{"Site", "Complexity Zoo", "https://complexityzoo.net/", "An encyclopaedia of complexity classes, for the curious."},
		},
		Blueprints: []Blueprint{
...
Kubernetes.`,
		...
		Resources: []Resource{
			...
			{"Paper", "Why Functional Programming Matters (Hughes)", "https://www.cs.kent.ac.uk/people/staff/dat/miranda/whyfp90.pdf", "A classic, readable argument for functional style."},
